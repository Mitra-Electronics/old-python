...
print('Loading your AI personal assistant - iVoice')
...
speak("Loading your AI personal assistant iVoice")
wish()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "good bye" in statement or "ok bye" in statement or "stop" in statement:
            speak('your personal assistant iVoice is shutting down,Good bye')
            print('Your personal assistant iVoice is shutting down, Good bye')
            break

        if 'wikipedia' in statement:
            speak('Searching Wikipedia...')
            wiki = statement.replace("wikipedia", "")
